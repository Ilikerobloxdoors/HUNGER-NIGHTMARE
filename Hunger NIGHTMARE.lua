...
local entity = Creator.createEntity({
    ...
    Model = "https://github.com/Ilikerobloxdoors/HUNGER-NIGHTMARE/blob/main/Hunger%20NIGHTMARE.rbxm",
    ...
    Jumpscare = {
        true,
        {
            Image1 = "http://www.roblox.com/asset/?id=11592258941",
            Image2 = "http://www.roblox.com/asset/?id=11592258941",
